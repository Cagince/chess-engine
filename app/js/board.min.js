var GameBoard, GeneratePosKey, PIECEINDEX, ParseFen, PrintBoard, ResetBoard, UpdateListMaterial;
...
UpdateListMaterial = function() {
  var colour, i, j, piece, results, sq;
  ...
  for (i = j = 0; j <= 63; i = ++j) {
    ...
    if (piece !== PIECES.EMPTY) {
      ...
      results.push(GameBoard.pieceAmount[piece]++);
    } else {
      results.push(void 0);
    }
  }
